...
Como estudante de Sistemas de Informação, desenvolvi fortes habilidades de **comunicação** e **liderança de equipe**, gerenciando prazos e garantindo o alinhamento em projetos acadêmicos. Minha experiência inclui um período em **Ciência da Computação no CESAR School**, onde vivenciei desafios reais em **equipes multidisciplinares**, negociei metas e otimizei processos de entrega.

Essa experiência me deu a maturidade para aplicar **metodologias ágeis** e **gestão colaborativa** em meus estudos atuais na UFRPE. Atualmente, meu foco é em **Data Science** e **Machine Learning**, desenvolvendo projetos como um modelo **Random Forest** para classificação de *fake news* e utilizando **Algoritmos Genéticos** para otimização de rotas.
